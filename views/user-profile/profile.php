          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  <div class="col-lg-4">
                    <img src="<?= $model->avatar ?>" alt="" style="border-radius: 23px;">
                  </div>
                  <div class="col-lg-4 align-self-center">
                    <div class="main-info header-text">
                      <span><?= Yii::$app->user->can('admin')?'admin':'user' ?></span>
                      <h4><?= $model->firstName . ' ' . $model->lastName ?></h4>

                      <div class="main-border-button">
                        <a href="<?= \yii\helpers\Url::to(['update', 'id'=>$model->id]) ?>">Chỉnh sửa</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 align-self-center">
                      <ul>
                          <li>Số điện thoại: <?= $model->phoneNum ?></li>
                          <li>Email: <?= $model->email ?></li>
                          <?php if(Yii::$app->user->can('admin')){ ?>
                                <li>Tổng số sản phẩm: <?= \app\models\Products::find()->count() ?> </li>
                          <?php } else{?>
                                <li>Số lượng sản phẩm: <?= \app\models\User::countProducts(Yii::$app->user->identity) ?></li>
                          <?php }?>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="clips">
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <?php $products = \app\models\View::getTop();?>
...
<!--              <div class="item">-->
<!--                <ul>-->
<!--                  <li><img src="template/assets/images/game-01.jpg" alt="" class="templatemo-item"></li>-->
...
<!--              <div class="item">-->
<!--                <ul>-->
<!--                  <li><img src="template/assets/images/game-02.jpg" alt="" class="templatemo-item"></li>-->
...
<!--                <ul>-->
<!--                  <li><img src="template/assets/images/game-03.jpg" alt="" class="templatemo-item"></li>-->
