...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class="active"><a href="<?= Url::to(['site/home']) ?>">Home</a></li>
                <li><a href="./shop-grid.html">Shop</a></li>
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="details2.php">Shop Details</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header__top__left">
                            <a href="<?= Url::to(['site/home']) ?>">Home</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
...
<!--                        <ul>-->
<!--                            <li><a href="--><?php //= \yii\helpers\Url::to(['site/home']) ?><!--">Home</a></li>-->
<!--                            <li class="active"><a href="--><?php //= Url::to(['site/home']) ?><!--">Shop</a></li>-->
<!--                            <li><a href="#">Pages</a>-->
<!--                                <ul class="header__menu__dropdown">-->
...
<!--    <section class="breadcrumb-section set-bg" data-setbg="image/bg.jpg">-->
<!--        <div class="container">-->
<!--            <div class="row">-->
...
<!--                            <a href="--><?php //= \yii\helpers\Url::to(['site/home']) ?><!--">Home</a>-->
